...
urlpatterns = [
    ...
    path('<int:pk>/update/<int:comment_id>/comment', comment_update_view, name='comment_update-view'),
    path('<int:pk>/delete/<int:comment_id>/comment', comment_delete_view, name='comment_delete-view')
]
